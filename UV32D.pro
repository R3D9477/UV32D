...
unrealRootPath=/home/eugene/Software/LinuxInstalled/UnrealEngine-4.25.4-release
UV32DRootPath=/home/eugene/Projects/r3d9u11/UV32D

gameProjectFile=/home/eugene/Projects/r3d9u11/UV32D/UV32D.uproject
...
include(UV32DSource.pri)
include(UV32DHeader.pri)
include(UV32DConfig.pri)
include(UV32DIncludes.pri)
include(UV32DDefines.pri)

UV32D-Linux-Debug.commands = $$build UV32D Linux Debug  -project="\"$$gameProjectFile\"" $$args
UV32D-Linux-DebugGame.commands = $$build UV32D Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UV32D-Linux-Shipping.commands = $$build UV32D Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UV32D-Linux-Test.commands = $$build UV32D Linux Test  -project="\"$$gameProjectFile\"" $$args
UV32D.commands = $$build UV32D Linux Development  -project="\"$$gameProjectFile\"" $$args

UV32DEditor-Linux-Debug.commands = $$build UV32DEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
UV32DEditor-Linux-DebugGame.commands = $$build UV32DEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UV32DEditor-Linux-Shipping.commands = $$build UV32DEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UV32DEditor-Linux-Test.commands = $$build UV32DEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
UV32DEditor.commands = $$build UV32DEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	UV32D-Linux-Debug \
	UV32D-Linux-DebugGame \
	UV32D-Linux-Shipping \
	UV32D-Linux-Test \
	UV32D \
	UV32DEditor-Linux-Debug \
	UV32DEditor-Linux-DebugGame \
	UV32DEditor-Linux-Shipping \
	UV32DEditor-Linux-Test \
	UV32DEditor \
