...
UV32D-Linux-Debug:
	 $(PROJECTBUILD) UV32D Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32D-Linux-DebugGame:
	 $(PROJECTBUILD) UV32D Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32D-Linux-Shipping:
	 $(PROJECTBUILD) UV32D Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32D-Linux-Test:
	 $(PROJECTBUILD) UV32D Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32D:
	 $(PROJECTBUILD) UV32D Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32DEditor-Linux-Debug:
	 $(PROJECTBUILD) UV32DEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32DEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UV32DEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32DEditor-Linux-Shipping:
	 $(PROJECTBUILD) UV32DEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32DEditor-Linux-Test:
	 $(PROJECTBUILD) UV32DEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UV32DEditor:
	 $(PROJECTBUILD) UV32DEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
